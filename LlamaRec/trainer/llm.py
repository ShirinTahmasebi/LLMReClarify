...
class LLMTrainer(Trainer):
    ...
    def test(self, test_retrieval):
        ...
        print('************************************************************')
        # with open(os.path.join(self.export_root, f'round_5/subset_metrics_{self.original_args.llm_gt_pos}.json'), 'w') as f:
        with open(os.path.join(self.export_root, f'random/subset_metrics_round_4.json'), 'w') as f:
        ...
        with open(os.path.join(self.export_root, f'random/overall_metrics_round_4.json'), 'w') as f:
            json.dump(overall_metrics, f, indent=4)
        
        print("Test - One round is completed!")
